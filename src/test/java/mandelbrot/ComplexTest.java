...
public class ComplexTest {
    ...
    void testSubtract() {
        ...
        assertEquals(Complex.ONE, Complex.ONE.subtract(Complex.ZERO));
        assertEquals(minusI, Complex.ZERO.subtract(Complex.I));
        assertEquals(minusOne, two.subtract(new Complex(3, 0)));
    }

    @Test
    void testMultiply() {
        assertEquals(Complex.ZERO, Complex.I.multiply(Complex.ZERO));
    ...
    void testPow() {
        ...
        assertEquals(new Complex(-4, 0), onePlusI.pow(4));
    }
    ...
    void testScale() {
        ...
        assertEquals(minusOne, new Complex(-2, 0).scale(.5));
    }
